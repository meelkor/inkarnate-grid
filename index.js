...
function createUi() {
    ...
    bottomButton.parentElement.insertBefore(makeRangeInput('0.01', '2', '0.001', 'scale'), bottomButton);
    bottomButton.parentElement.insertBefore(makeRangeInput('0', '1', '0.01', 'offsetX'), bottomButton);
    bottomButton.parentElement.insertBefore(makeRangeInput('0', '1', '0.01', 'offsetY'), bottomButton);
}
